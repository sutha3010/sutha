...
l1=tk.Label(window,text="Celsius to Fahrenheit convertor!",font=("Arial",15),fg="white",bg="black")
l2=tk.Label(window,text="Enter Temperature",font=("Arial",10,"bold"),fg="white",bg="#A569BD")
